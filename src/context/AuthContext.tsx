...
interface AuthContextType {
  ...
  register: (name: string, email: string, heroClass: HeroClass, password?: string) => Promise<void>;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const register = async (name: string, email: string, heroClass: HeroClass, password?: string) => {
